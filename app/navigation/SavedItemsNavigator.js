...
import SaveDashboardScreen from '../screens/SavedDashboardScreen';

const Stack = createSharedElementStackNavigator();

const SavedItemsNavigator = () => {
	return (
		<Stack.Navigator screenOptions={{ headerShown: false }}>
			<Stack.Screen name="AdsList" component={SaveDashboardScreen} />
			<Stack.Screen
...
export default SavedItemsNavigator;
